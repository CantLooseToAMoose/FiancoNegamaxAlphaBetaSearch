...
import Fianco.AI.Search.AlphaBeta.IterativeABWithQuiescenceAndKillerMoves;
import Fianco.AI.Search.TT.Zobrist;

import java.util.ArrayList;

public class IterativeAlphaBetaSearchAgentQuiescenceAndKillerMoves implements IAgent {
    public static final int MAX_GAME_MOVES = 600;

    private BitmapFianco fianco;
    private final int player;
    private IterativeABWithQuiescenceAndKillerMoves alphaBetaSearch;
    private long[] board;
    ...
    public void resetBoard(int[][] board) {
        ...
        alphaBetaSearch = new IterativeABWithQuiescenceAndKillerMoves();
    ...
    public IterativeAlphaBetaSearchAgentQuiescenceAndKillerMoves(BitmapFianco fianco, int player) {
        this.fianco = fianco;
        this.player = player;
        this.alphaBetaSearch = new IterativeABWithQuiescenceAndKillerMoves();
